<%@ Page Title="About" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="About.aspx.cs" Inherits="comp2007_s2016_asgn_1.About" %>
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <bs3:Jumbotron runat="server" ID="Jumbotron">
        <Body>
            <div class="page-header">
                <h1>A little about John...</h1>
            </div>
            <p>
                Hello, my name is John Horne and currently enrolled as a student at Georgian College.
            ...
            <p>
                In my free time, I design and build web applications, Java programs as a hobby as well as 
